class ArtifactsController < ApplicationController
  ...
  def index
    ...
    # binding.pry
    @artifacts.project_id = params[:project]
  end
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to tenant_project_url(tenant_id: current_tenant.id, 
  ...
  def update
    respond_to do |format|
      if @artifact.update(artifact_params)
        format.html {  redirect_to tenant_project_url(tenant_id: current_tenant_id, 
                                                      id: @artifact.project_id), 
                                                      notice: "Artifact was successfully created." }
